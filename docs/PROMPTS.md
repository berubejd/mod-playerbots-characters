...
- `{equipment}` — dynamic multi-line equipment description. Rarity adjectives and weapon names are included only for rare+ quality items; below rare only the type is shown (e.g. "a dagger" not "a common dagger"). When bags are at least ~40% full, a bag-space summary is also appended. Examples:
  - Full set: "You have fine equipment made of leather.\nYour main weapon is a rare dagger called Death's Sting.\nIn your off-hand you wield a dagger.\nYour ranged weapon is a rare bow called Heartstriker."
  - Two-hander: "You have excellent equipment made of plate.\nYour main weapon is an epic two-handed mace called Devastation. Your bags are almost full."
  - Bare minimum: "You have simple equipment.\nYour main weapon is a dagger."
  - No armor: "You have no armor.\nYour main weapon is a one-handed sword."
